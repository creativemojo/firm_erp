...
$page_title = "Add Supplier | Firm Management System";
...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($connect, "insert into fm_suppliers(`s_name`, `s_email`, `s_mobile`, `s_addr`, `s_gstin`) values('$name', '$email', '$mobile', '$address', '$gstin')");
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="gstin" name="gstin" placeholder="GSTIN" class="form-control" value="<?php echo isset($gstin)? $gstin : ''; ?>">
                                                    <small class="help-block form-text" style="color:red;">
