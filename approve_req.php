...
$page_title = "Approve Request | Firm Management System";

include_once("header.php"); 

$id = $_REQUEST['id'];

$query = mysqli_query($connect,"select * from fm_employees where e_id=$id && e_status=0");
...
if(isset($_POST['submit'])){
    ...
    $query1 = mysqli_query($connect, "update fm_employees set `e_fname`='$fname', `e_lname`='$lname', `e_email`='$email', `e_pass`='$password', `e_aadhar`='$aadhar', `e_mobile`='$mobile', `e_address`='$address', `e_designation`='$designation', `e_salary`='$salary', `e_status`=1 where e_id=$id");
                            ...
                            <div class="col-lg-12" style="overflow-x:auto">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Approve</strong> Employee
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="password" name="password" placeholder="Create Password" class="form-control" value="<?php echo $row['e_pass']; ?>">
                                                    <small class="help-block form-text" style="color:red;">
