...
$query_old = mysqli_query($connect, "select u_password from fm_users where `u_id`='$id'");
...
if(isset($_POST['submit'])){
    ...
    }elseif($row_old['u_password'] == $old_pass){

        if($new_pass == $con_pass){

            $query = mysqli_query($connect, "update fm_users set `u_password`='$new_pass' where `u_id`='$id'");
